...
var me = new Student('Moti Elmakies', 41, 'Computer Science');
var other = new Student('Anna Blanki', 32);
var traveler = new Traveler('Scott Land', 25, 'Israel');
// console.log(traveler.hasHomeLocation());
var peopoles = [me, other, traveler];

peopoles.forEach(function (p) {
